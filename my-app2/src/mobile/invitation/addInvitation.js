...
class AddInvitationView extends React.Component{
        ...
        //window.alert('code'+data.code);
                if(data.code==0) {
                 ...
                 this.setState({visible: false});
                  this.props.history.push('/mobile/invitation');
                }
                else {
                  setTimeout(hide)
                  Toast.faile(data.msg);
                }
            }
        )
  }
  componentDidMount() {
    ...
    editor.customConfig.uploadImgServer = 'http://192.168.31.69:9999/uploadImg';
...
export default AddInvitationView;